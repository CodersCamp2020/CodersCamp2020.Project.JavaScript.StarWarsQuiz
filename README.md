...
- Ocena dostarczonego kodu i działania aplikacji przez 2 mentorów (wasz mentor i jeden z obecnych na prezentacji):
    - Jako zespół otrzymacie liczbę punktów od obu mentorów (wg kryteriów //TODO podlinkować - Readme, kod, testy, ui), która zostanie pomnożona przez procenty zaangażowania.
